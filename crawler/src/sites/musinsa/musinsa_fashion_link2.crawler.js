...
const URL = "https://www.musinsa.com/main/outlet/recommend?gf=A";
...
const musinsaLabelToSlug = {
  "반소매 티셔츠": "ao-thun",       // Khớp ID 311
  "긴소매 티셔츠": "ao-thun",       // Gộp chung vào Áo thun (ID 311)
  "셔츠/블라우스": "ao-so-mi",      // Khớp ID 312
  "후드 티셔츠": "ao-hoodie",       // Khớp ID 316
  "맨투맨/스웨트": "ao-sweatshirt",  // Khớp ID 317
  "숏 팬츠": "quan-short",          // Khớp ID 315
  "팬츠": "quan-vay",               // Khớp ID 314
  "트레이닝 팬츠": "quan-vay",       // Gộp chung vào quần dài (ID 314)
  "스니커즈": "giay-sneaker-boots", // Khớp ID 321
  "샌들/슬리퍼": "giay-sneaker-boots", // Gộp chung vào giày/boots (ID 321)
  "가방": "tui-xach-bags",          // Khớp ID 331
  "패션소품": "phu-kien-thoi-trang", // Khớp ID 35
  "스포츠/레저": "phu-kien-thoi-trang",// Gộp tạm vào phụ kiện thời trang (ID 35)
  "키즈": "life-goods"              // Khớp ID 55
};

// Danh mục "전체" (Tất cả) đã nằm trong danh sách skip nên sẽ tự động bỏ qua hợp lý
